                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('users.update', $user->id)}}" id="userForm" enctype="multipart/form-data" method="POST">
                                            @csrf
                                            @method('put')
                                            <div class="row">   
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="name" maxlength="200" value="{{old('name',$user->name)}}" class="form-control" placeholder="Enter name">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Email @error('email') <span class="text-danger"> {{ $message }} </span> @enderror</label>
                                                        <input type="text" name="email" maxlength="200" value="{{old('email',$user->email)}}" class="form-control" placeholder="Enter email">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <optgroup label="Select permissions">
                                                            ...
                                                            <option value="{{$permission->id}}" {{ in_array($permission->id, old('permissions', $user->permissions->pluck('id')->toArray())) ? 'selected' : '' }} >{{$permission->name}}</option>
                                                            @endforeach
                                                        </optgroup>    
                                                    </select>
                                                    </div>
