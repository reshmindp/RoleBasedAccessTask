                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('posts.update', $post->id)}}" id="postForm" enctype="multipart/form-data" method="POST">
                                            @csrf
                                            @method('put')
                                            <div class="row">   
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="title" maxlength="200" value="{{old('title', $post->title)}}" class="form-control" placeholder="Enter title">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <optgroup label="Select categories">
                                                            ...
                                                            <option value="{{$category->id}}" {{ collect(old('categories', $post->categories->pluck('id')))->contains($category->id) ? 'selected' : '' }}>{{$category->name}}</option>
                                                            @endforeach
                                                        </optgroup>    
                                                    </select>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea rows="4" name="description" class="form-control" placeholder="Enter Description">{{old('description', $post->description)}}</textarea>
                                                    </div>
                                                </div>
